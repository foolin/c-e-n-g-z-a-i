...
namespace CengZai.DAL
{
	...
	public partial class ArtReply
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ReplyID", "T_ArtReply"); 
		}
		...
		public bool Exists(int ReplyID)
		{
			...
			strSql.Append("select count(1) from T_ArtReply");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_ArtReply(");
			strSql.Append("ArtID,Content,UserID,PostTime,PostIP,ReportCount,State)");
			...
			parameters[5].Value = model.ReportCount;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_ArtReply set ");
		...
		public bool Delete(int ReplyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_ArtReply ");
			strSql.Append(" where ReplyID=@ReplyID");
			SqlParameter[] parameters = {
					new SqlParameter("@ReplyID", SqlDbType.Int,4)
			};
		...
		public CengZai.Model.ArtReply GetModel(int ReplyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ReplyID,ArtID,Content,UserID,PostTime,PostIP,ReportCount,State from T_ArtReply ");
			strSql.Append(" where ReplyID=@ReplyID");
			SqlParameter[] parameters = {
					new SqlParameter("@ReplyID", SqlDbType.Int,4)
			};
			...
			CengZai.Model.ArtReply model=new CengZai.Model.ArtReply();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ReplyID,ArtID,Content,UserID,PostTime,PostIP,ReportCount,State ");
			strSql.Append(" FROM T_ArtReply ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ReplyID,ArtID,Content,UserID,PostTime,PostIP,ReportCount,State ");
			strSql.Append(" FROM T_ArtReply ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_ArtReply T ");
